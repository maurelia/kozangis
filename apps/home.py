...
def app():
    ...
    m.add_marker([latitude, longitude], popup=None, tooltip=None, icon=(color: str = 'blue', icon_color: str = 'white', icon: str = 'crosshairs',prefix: str = 'fa'), draggable=False,zoo)     
